...
contour(zs,xs,ys,heatOrContour="both",extras=[invertContourColors],title="inverted color, both") # TODO FAILS
contour(zs,xs,ys,heatOrContour="both",cmap="viridis",title="both") # TODO FAILS
contour(zs,xs,ys,heatOrContour="both",linestyle=":",title="both, ls = :") # TODO FAILS
contour(zs,xs,ys,heatOrContour="both",linestyle=ls,linewidth=3,title="linestyle, linewidth") # TODO FAILS
contour(zs,xs,ys,heatOrContour="both",linestyle=ls,linecolor=["black"]*5+["red"]+["black"]*40,title="custom line colors") # TODO FAILS
